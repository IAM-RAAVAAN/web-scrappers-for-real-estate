...
import logging
logging.basicConfig(filename='99.log', level=logging.DEBUG,
                    format='%(levelname)s:%(message)s:%(asctime)s')
logging.debug('99runing')

# In[189]:


url = 'https://www.99acres.com/property-in-pune-ffid'
j = requests.get(url)
k = j.text
...
the_data_pull = []
#browser = webdriver.Firefox(executable_path="/usr/bin")
browser.get(url)
